...
// Displays a export hire request where the customer can update or delete the hire request
...
// popup to show cost estimate for the hire
    ...
    // Set state with selected loading port
    handleLoadingPort= (e) => {
        if(e.target.value){
            this.setState({
                    ...
                    <Card border="primary">
                        ...
                        <form onSubmit={this.handleSubmit} autoComplete='off'>
                            ...
                            <div className="input-field row col-12" >
                                <textarea type="text" id="remarks" placeholder="Remarks" value={this.state.remarks} style={{ minHeight: 100 }}  onChange={this.handleChange}/>
                            </div>
                            </Card.Body>
                        </Card>
                            <br/><br/>
