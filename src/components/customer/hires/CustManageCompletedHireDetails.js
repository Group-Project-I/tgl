                    ...
                    <div className="container www fadeIn animated slow delay-1s">
                        ...
                        <Card border="primary" ref={el => (this.componentRef = el)}>
                            <Card.Body>
                                ...
                                <br/>
                                <Card border="primary" className="text-center">
                                    <Card.Header color="blue"><h4>Vehicle Details</h4></Card.Header>
                                    <Card.Body>
                                        <div className="row" style={{paddingTop: '40px'}}>
                                            <div className="col-6">
                                ...
                                <Card border="primary" className="text-center">
                                    ...
                                    <Card.Body>
                                        <div className="row" style={{paddingTop: '40px'}}>
                                            <div className="col-12">
                                                <h6 className="left"><b className='blue-text'>Status: </b> <b className="green badge1">{this.props.hire[0].hireStatus}</b> </h6>
                                            </div>
                                        </div>
                                        <br/><br/>
